...
import { Smartphone, CheckCircle, ArrowRight, Zap, Target, Layers } from 'lucide-react';
import Link from 'next/link';

export default function MobileService() {
    const features = [
        { title: 'iOS & Android', desc: 'Performance-obsessed native and hybrid development.' },
        { title: 'React Native', desc: 'Bespoke cross-platform builds for rapid scaling.' },
        { title: 'Optimization', desc: 'App Store scaling and performance engineering.' },
        { title: 'UX Mobile Design', desc: 'Thumb-friendly UI architectures for conversion.' },
        { title: 'Maintenance', desc: 'Continuous security updates and environment scaling.' },
        { title: 'Offline Support', desc: 'Building logic that functions without connection.' }
    ];
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-24">
                        <div className="flex-1 space-y-12">
                            <div className="inline-flex items-center gap-4 px-6 py-2 rounded-full border border-white/10 bg-white/[0.02] text-primary uppercase font-black text-xs tracking-[0.3em]">
                                ...
                                <span>Mobile First Logic</span>
                            </div>
                            <h1 className="text-7xl md:text-9xl font-[900] italic tracking-tighter uppercase leading-[0.85] font-heading">
                                Mobile <br /> <span className="gradient-text italic opacity-60">Experience</span> <br /> Engineering
                            </h1>
                            <p className="text-2xl text-muted-foreground max-w-2xl font-medium font-sans tracking-tight">
                                Architecting mobile products that users crave. Fast, secure, and resilient mobile ecosystems for global industries.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-10 pt-4">
                                <Link href="/contact" className="px-12 py-6 rounded-full bg-white text-black font-black text-2xl uppercase tracking-tighter hover:scale-105 transition-all shadow-2xl">Start Engineering</Link>
            ...
            <section className="py-32 border-y border-white/5 bg-white/[0.01]">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-24 space-y-6">
                        ...
                        <h2 className="text-5xl md:text-8xl font-[900] uppercase italic tracking-tighter font-heading leading-tight">Native <span className="gradient-text italic">Performance</span></h2>
                    </div>
