...
export function SpotlightNavbar({
    ...
    const [activeIndex, setActiveIndex] = useState(currentActiveIndex !== -1 ? currentActiveIndex : 0);
            ...
            >
                        ...
                        <li key={idx} className="relative h-full flex items-center">
                            <a
                                ...
                                className={cn(
                                    ...
                                    'focus-visible:outline-none relative group pr-2',
                                    activeIndex === idx ? 'text-white' : 'text-white/40 hover:text-white'
                                )}
                            >
                                ...
                                {activeIndex === idx && (
                                    <motion.div
                                        ...
                                        className="absolute inset-x-2 inset-y-1.5 bg-[#0088ff]/20 rounded-full -z-0"
                                    />
                                )}
                            </a>
                        </li>
                ...
                <div className="pointer-events-none absolute inset-0 z-[1] transition-opacity duration-300"
                    style={{
                        ...
                        background: `radial-gradient(120px circle at var(--spotlight-x) 100%, rgba(0,136,255,0.2) 0%, transparent 60%)`,
                    }}
                />
