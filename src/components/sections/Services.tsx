            ...
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-24 gap-8">
                    <div className="max-w-xl space-y-6">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-tight font-heading">
                            Core <span className="gradient-text italic">Expertise</span>
                        </h2>
                    </div>
                    <p className="text-muted-foreground text-xl max-w-sm font-medium leading-relaxed font-sans">
                    ...
                    {services.map((service, i) => (
                        <Link key={i} href={`/services/${service.slug}`} className="h-full">
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-black mb-6 flex items-center justify-between group-hover:text-primary transition-colors font-heading uppercase tracking-tighter">
                                    {service.title}
                                </h3>
                                <p className="text-muted-foreground text-lg leading-relaxed font-medium mb-12 line-clamp-3">
                                    {service.description}
                                </p>
